...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class NewsPreferenceFragment extends PreferenceFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference categoryBy=findPreference("category preference");
            setOnPreferenceClickCategory(categoryBy);
            bindPreferenceSummaryToValue(categoryBy);
        ...
        private void setOnPreferenceClickCategory(Preference categoryBy) {
            categoryBy.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
